...
// Отказ сервера выполнять команду
// Добавить событие: CommandRejected(playerId, reason: String)
// Если игрок выбирает ChoiceSelected(... "help"), когда он еще не OFFERED -> сервер публикует CommandRejected.

// Сделать кнупку атаки (тестовая цель атаки - любая) - обязательно проверять перед событиями, может ли он атаковать
// Состоять она будет из 2 событий и кулдауна
// 1 событие игрок нажал кнопку атаки
// 2 событие ирон по цели нанесен

// Бафф скорости атаки
// Добавь: AttackSpeedBuffApplied(playerId, ticks: Int)
// Пока бафф активен кулдаун атаки 1200ms -> 700ms